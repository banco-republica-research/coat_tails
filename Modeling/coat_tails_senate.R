...
l_f <- function(o){
  r <- rdrobust(y = l[,o],
                ...
                all = T,
                vce = "nn")
  pdf(str_c(results, "/Graphs/Senate", "/RD_", o, "1_coalition", ".pdf"), height=6, width=12)
...
r <-lapply(out, l_f) 
saveRDS(r, str_c(results, "/coat_tails_senate1_coalition.rds"))
...
l_f <- function(o){
  r <- rdrobust(y = l[,o],
                ...
                all = T,
                vce = "nn")
  pdf(str_c(results, "/Graphs/Senate", "/RD_", o, "final_coalition", ".pdf"), height=6, width=12)
  rdplot(y=l2[,o], x=l2$margin_prop_2, c = 0,
         # y.lim = c(0.2, 0.8),
         # x.lim = c(0.45, 0.55),
         title = " ",
...
l_f <- function(o){
  r <- rdrobust(y = l[,o],
                ...
                all = T,
                vce = "nn")
  pdf(str_c(results, "/Graphs/Senate", "/RD_", o, "2_coalition", ".pdf"), height=6, width=12)
  rdplot(y=l2[,o], x=l2$margin_prop_2, c = 0,
         # y.lim = c(0.2, 0.8),
         # x.lim = c(0.45, 0.55),
         title = " ",
...
r <- lapply(out, l_f) 
saveRDS(r, str_c(results, "/coat_tails_senate2_coalition.rds"))
...
l_f <- function(o){
  r <- rdrobust(y = l[,o],
                ...
                all = T,
                vce = "nn")
  pdf(str_c(results, "/Graphs/Senate", "/RD_", o, "party", ".pdf"), height=6, width=12)
  rdplot(y=l2[,o], x=l2$margin_prop_2, c = 0,
         # y.lim = c(0.2, 0.8),
         # x.lim = c(0.45, 0.55),
         title = " ",
...
representantes_coalition <- readRDS(paste0(res,"senate_coalition_current_merge.rds"))
...
l_f <- function(o){
  r <- rdrobust(y = l[,o],
                ...
                all = T,
                vce = "nn")
  pdf(str_c(results, "/Graphs/Senate", "/RD_", o, "current_coalition", ".pdf"), height=6, width=12)
  rdplot(y=l2[,o], x=l2$margin_prop_2, c = 0,
         # y.lim = c(0.2, 0.8),
         # x.lim = c(0.45, 0.55),
         title = " ",
...
r <- lapply(out, l_f)
saveRDS(r, str_c(results, "/coat_tails_senate_current_coalition.rds"))
